# Generated by Django 4.2.20 on 2025-04-26 22:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_stock_level', models.PositiveIntegerField(default=10, help_text='Minimum stock level before alert is triggered')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='product',
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='products', to='gestion_api.productcategory'),
        ),
        migrations.AddField(
            model_name='product',
            name='created_by',
        ...
        migrations.AddField(
            model_name='product',
            name='unit',
            field=models.ForeignKey(db_column='unit', on_delete=django.db.models.deletion.PROTECT, to='gestion_api.unitofmeasure'),
        ),
        migrations.CreateModel(
            name='Invoice',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('sale', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='invoices', to='gestion_api.sale')),
            ],
        ),
        migrations.CreateModel(
            name='InventoryItem',
            fields=[
                ...
                ('actual_quantity', models.DecimalField(decimal_places=2, max_digits=10, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_type', models.CharField(choices=[('income_statement', 'Income Statement'), ('balance_sheet', 'Balance Sheet'), ('cash_flow', 'Cash Flow Statement'), ('receivables', 'Accounts Receivable'), ('payables', 'Accounts Payable'), ('custom', 'Custom Report')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField()),
                ('is_active', models.BooleanField(default=True)),
                ('from_currency', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rates_from', to='gestion_api.currency')),
                ('to_currency', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rates_to', to='gestion_api.currency')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reference', models.CharField(max_length=50, unique=True)),
                ('date', models.DateField()),
                ('flow_type', models.CharField(choices=[('income', 'Income'), ('expense', 'Expense'), ('transfer', 'Transfer'), ('client_payment', 'Client Payment'), ('supplier_payment', 'Supplier Payment')], max_length=20)),
                ('amount', models.DecimalField(decimal_places=2, max_digits=15, validators=[django.core.validators.MinValueValidator(0)])),
                ('description', models.TextField()),
                ('related_document_type', models.CharField(blank=True, max_length=50, null=True)),
                ('related_document_id', models.IntegerField(blank=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='cash_flows', to='gestion_api.account')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('transaction_type', models.CharField(choices=[('deposit', 'Deposit'), ('withdrawal', 'Withdrawal'), ('check', 'Check'), ('fee', 'Fee'), ('interest', 'Interest'), ('transfer', 'Transfer'), ('other', 'Other')], max_length=20)),
                ('transaction_date', models.DateField()),
                ('description', models.TextField()),
                ('amount', models.DecimalField(decimal_places=2, max_digits=15)),
                ('is_reconciled', models.BooleanField(default=False)),
                ('reference_document', models.CharField(blank=True, max_length=50, null=True)),
                ('reconciliation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='gestion_api.bankreconciliation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField()),
                ('transaction_type', models.CharField(choices=[('client_payment', 'Règlement client'), ('supplier_payment', 'Règlement fournisseur'), ('transfer_in', 'Virement entrant'), ('transfer_out', 'Virement sortant'), ('cash_receipt', 'Encaissement'), ('cash_payment', 'Décaissement'), ('expense', 'Dépense'), ('sale', 'Vente'), ('purchase', 'Achat')], max_length=20)),
                ('reference', models.CharField(max_length=50)),
                ('description', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_stock_level', models.IntegerField(default=10, help_text='Minimum stock level before reordering')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_stocks', to=settings.AUTH_USER_MODEL)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stocks', to='gestion_api.product')),
                ('zone', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gestion_api.zone')),
            ],
            options={
